...
class BASE_EXPORT TraceConfig {
 public:
  TraceConfig(StringPiece category_filter_string, StringPiece trace_options_string) {}
...
class BASE_EXPORT TraceLog {
 public:
  ...
  using OutputCallback = base::RepeatingCallback<void(const scoped_refptr<base::RefCountedString>&,
...
class TracedProto {
 public:
  // implicit
  TracedProto(TracedValue&& value) : TracedProto() {}
  ~TracedProto() = default;
  ...
  // instead.
  template <typename FieldMetadata, typename ValueType>
  void AppendValue(protozero::proto_utils::internal::FieldMetadataHelper<FieldMetadata>,
                   ValueType&& value) {}
  ...
  // instead.
  template <typename FieldMetadata, typename ValueType>
  void AppendFrom(protozero::proto_utils::internal::FieldMetadataHelper<FieldMetadata>,
                  ValueType&& value) {}
 ...
 private:
  ...
  TracedProto(MessageType* message, EventContext* context) : message_(message), context_(context) {}
